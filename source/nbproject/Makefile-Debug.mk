...
${OBJECTDIR}/Borne.o: Borne.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../testtp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Borne.o Borne.cpp

${OBJECTDIR}/BorneFontaine.o: BorneFontaine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../testtp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneFontaine.o BorneFontaine.cpp

${OBJECTDIR}/BorneStationnement.o: BorneStationnement.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../testtp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneStationnement.o BorneStationnement.cpp

${OBJECTDIR}/ContratException.o: ContratException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../testtp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContratException.o ContratException.cpp

${OBJECTDIR}/RegistreBorne.o: RegistreBorne.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../testtp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegistreBorne.o RegistreBorne.cpp

${OBJECTDIR}/validationFormat.o: validationFormat.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../testtp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/validationFormat.o validationFormat.cpp
...
${TESTDIR}/tests/BorneFontaineTesteur.o: tests/BorneFontaineTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BorneFontaineTesteur.o tests/BorneFontaineTesteur.cpp


${TESTDIR}/tests/BorneStationnementTesteur.o: tests/BorneStationnementTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BorneStationnementTesteur.o tests/BorneStationnementTesteur.cpp


${TESTDIR}/tests/BorneTesteur.o: tests/BorneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BorneTesteur.o tests/BorneTesteur.cpp


${TESTDIR}/tests/RegistreBorneTesteur.o: tests/RegistreBorneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RegistreBorneTesteur.o tests/RegistreBorneTesteur.cpp
...
${OBJECTDIR}/Borne_nomain.o: ${OBJECTDIR}/Borne.o Borne.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../../testtp -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Borne_nomain.o Borne.cpp;\
	else  \
...
${OBJECTDIR}/BorneFontaine_nomain.o: ${OBJECTDIR}/BorneFontaine.o BorneFontaine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../../testtp -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneFontaine_nomain.o BorneFontaine.cpp;\
	else  \
...
${OBJECTDIR}/BorneStationnement_nomain.o: ${OBJECTDIR}/BorneStationnement.o BorneStationnement.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../../testtp -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BorneStationnement_nomain.o BorneStationnement.cpp;\
	else  \
...
${OBJECTDIR}/ContratException_nomain.o: ${OBJECTDIR}/ContratException.o ContratException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../../testtp -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContratException_nomain.o ContratException.cpp;\
	else  \
...
${OBJECTDIR}/RegistreBorne_nomain.o: ${OBJECTDIR}/RegistreBorne.o RegistreBorne.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../../testtp -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegistreBorne_nomain.o RegistreBorne.cpp;\
	else  \
...
${OBJECTDIR}/validationFormat_nomain.o: ${OBJECTDIR}/validationFormat.o validationFormat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../../testtp -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/validationFormat_nomain.o validationFormat.cpp;\
	else  \
